 ...
 */
export class MovingTargetSound {
  ...
  constructor(p) {
    this.p5 = p;
    this.env = new p5.Envelope(0.000001, 0.1, 0.08, 0.1, 0.00001, 0);
    this.osc = new p5.Oscillator();
    this.osc.setType('square');
    this.osc.amp(0);
    this.pattern = [880];
    this.phrase = new p5.Phrase('movingtarget', (t, p) => {this.makeSound(t, p)}, this.pattern);
