 ...
 */
export class TenGridResponsive {
  ...
  constructor(p, letters, options = null) {
    ...
    this.isPortrait = p.windowWidth < p.windowHeight
    this.maxWidth = this.isPortrait
      ? p.windowWidth
    ...
    tengrid.id("tengrid")
      ...
      // .style('top', '75vh')
      .style('bottom', '5vh')
      .style('width', (95 / 100) * p.width + 'px')
      .style('left', p.width / 2 - (95 / 200) * p.width + 'px')
  ...
  createButton(letter, id) {
    ...
    button.id(id)
      ...
      .style('width', this.isPortrait
        ? (19 / 100) * this.maxWidth + 'px'
        : (19 / 200) * p.width + 'px'
      )
      .style('height', this.isPortrait
        ? '11vh'
        : '20vh'
      )
      .style('box-sizing', 'content-box')
      .style('font-size', this.isPortrait
        ? (10 / 100) * this.maxWidth + 'px'
        : (15 / 100) * this.maxWidth + 'px'
      )
